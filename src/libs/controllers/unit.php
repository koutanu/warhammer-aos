...
class Unit extends Controller
{
	...
	function create()
	{
		...
		$data = [
			...
			'all_unit_keywords'    => $this->model->getAllKeywords('unit'),
			'all_faction_keywords' => $this->model->getAllKeywords('faction'),
			'unit_keyword_links'   => [],
			'faction_keyword_links' => [],
	...
	function edit($unitId = '')
	{
		...
		$data = [
			...
			'all_unit_keywords'    => $this->model->getAllKeywords('unit'),
			'all_faction_keywords' => $this->model->getAllKeywords('faction'),
			'unit_keyword_links'   => $this->model->getUnitKeywordLinksByType($unitId, 'unit'),
			'faction_keyword_links' => $this->model->getUnitKeywordLinksByType($unitId, 'faction'),
	...
	function save()
	{
		...
		$data = [
			...
			'unit_keyword_ids'    => is_array($_POST['unit_keyword_ids'] ?? null) ? $_POST['unit_keyword_ids'] : [],
			'unit_keyword_params' => is_array($_POST['unit_keyword_params'] ?? null) ? $_POST['unit_keyword_params'] : [],
			'faction_keyword_ids' => is_array($_POST['faction_keyword_ids'] ?? null) ? $_POST['faction_keyword_ids'] : [],
			'faction_keyword_params' => is_array($_POST['faction_keyword_params'] ?? null) ? $_POST['faction_keyword_params'] : [],
